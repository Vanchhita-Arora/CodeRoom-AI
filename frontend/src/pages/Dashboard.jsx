...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#0F1117] text-white font-sans selection:bg-pink-300 selection:text-white">
      ...
      <main className="max-w-4xl mx-auto py-16 px-6 relative">
        ...
        <div className="relative bg-[#1e1b3a]/95 border border-white/15 rounded-3xl shadow-2xl overflow-hidden p-8 sm:p-10">
          ...
          <form onSubmit={handleJoinRoom} className="space-y-8">
            ...
            {/* Mode Selection */}
            <div>
              <Label className="text-white/90 text-xs font-bold tracking-widest mb-4 block drop-shadow-sm">Select environment mode</Label>
            ...
            {mode === 'interview' && (
              <div className="animate-in fade-in slide-in-from-top-4 duration-300">
                <Label className="text-white/90 text-xs font-bold tracking-widest mb-4 block drop-shadow-sm">Select your role</Label>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div 
                ...
                {isStudent && <p className="text-pink-200/90 text-sm mt-3 font-medium drop-shadow-sm">Students are restricted to the Candidate role only.</p>}
              </div>
            )}

            <div className="pt-4">
              <Label htmlFor="roomId" className="text-white/90 text-xs font-bold tracking-widest mb-2 block drop-shadow-sm">Room ID</Label>
              <Input
                id="roomId"
                type="text"
                value={roomId}
