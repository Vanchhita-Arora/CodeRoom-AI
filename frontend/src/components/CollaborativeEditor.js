        ...
        <div className="collaborative-editor" style={{ display: 'flex', flexDirection: 'column', height: '100vh', background: '#1e1e1e' }}>
            ...
            <div className="workspace-container">
                <div className="left-editor-panel" style={{ flex: isRestrictedUser ? '1' : (mode === 'ide' ? '0 0 65%' : '0 0 70%') }}>
                    ...
                    {mode === 'ide' && (
                        <div className="terminal-section" style={{ height: '30%', borderTop: '1px solid #1e1e2e' }}>
                            <Terminal roomId={currentRoomId} />
                        </div>
                    )}
                    {
                        <div className="output-section" style={{ height: '150px', overflowY: 'auto', background: '#0a0a0c', color: '#f3f4f6', borderTop: '1px solid #1e1e2e', padding: '12px 16px' }}>
                            <h3 style={{ margin: '0 0 8px 0', fontSize: '12px', fontWeight: 'bold', letterSpacing: '0.5px', color: '#a855f7' }}>Output Console</h3>
