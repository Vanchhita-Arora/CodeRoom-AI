    ...
    return (
        <div className="agent-chat" style={{ display: 'flex', flexDirection: 'column', height: '100%', background: '#0a0a0a', borderLeft: '1px solid #333' }}>
            ...
            <div style={{ flexGrow: 1, overflowY: 'auto', padding: '20px', display: 'flex', flexDirection: 'column', gap: '15px' }}>
                {messages.length === 0 && (
                    <div style={{ color: '#6b7280', textAlign: 'center', marginTop: '40px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '15px' }}>
                        <span style={{ fontSize: '30px' }}>✨</span>
                        <span>Ask me anything about your code!</span>
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', width: '100%', maxWidth: '250px', marginTop: '10px' }}>
                            {['Review my code', 'Explain this function', 'Find bugs'].map((prompt, i) => (
                                <button 
                                    key={i}
                                    ...
                                    onMouseOver={(e) => { e.target.style.background = '#374151'; e.target.style.borderColor = '#a855f7'; }}
                                    onMouseOut={(e) => { e.target.style.background = '#1f2937'; e.target.style.borderColor = '#374151'; }}
                                >
                                    {prompt}
                                </button>
                            ))}
